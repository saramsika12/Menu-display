  ...
  return (
    <main className="menu">
      ...
      {numPizzas > 0 ? (
        ...
        dishes to choose from our stone oven, all organic,
        all delicious.
      </p>
      ...
      <Pizza name="Pizza Fungi" ingredients="Tomato, mushrooms" price={12}
      photoName="pizzas/funghi.jpg"
      /> */}
    </main>
  );
...
//     return (
//   <li className="pizza">
//     <img src={pizzaObj.photoName} alt={pizzaObj.name} className="pizza.sold-out img" />
//     <div>
//       <h3>{pizzaObj.name}</h3>
